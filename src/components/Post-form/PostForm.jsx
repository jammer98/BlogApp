...
function PostForm({post}) {
    ...
    const slugTransform = useCallback((value) => {
        if(value && typeof value === 'string'){
            return value .trim().toLowerCase().replace(/^[a-zA-Z\d\s]+/g, '-')  //^ this negate means dont do anything with this value
            .replace(/\s/g,'-')// replace chars a-z and A-z and digits and spaces globally and replace it with -
        }
        return ''
    },[])
